...
<br>
<p align="center">
  <img alt="Logo do Projeto" src="assets/logo_c3.png" width="35%">
</p>

🌐 Documentação

* 📄 Documentação em PDF: Clique aqui para acessar
...
A proposta busca aumentar a segurança do idoso e facilitar o acompanhamento remoto pelo cuidador, oferecendo uma solução prática baseada em Internet das Coisas, sistemas embarcados, robótica inclusiva e interface web.
...
* Aviso por Voz: utiliza caixa de som para avisar o idoso sobre o horário dos medicamentos.
...
flowchart LR
C[Cuidador] --> A[Aplicação Web do Andador Inteligente]
I[Idoso] --> W[Andador Inteligente]
W --> R[Raspberry Pi]
R --> A
R --> GPS[GPS NEO-6M]
R --> MPU[MPU6050]
...
Quedas[Registro de Quedas]
Telegram[Serviço Telegram]
GPS[Serviço GPS]
MPU[Serviço Acelerômetro]
Camera[Serviço de Câmera]
Buzzer[Serviço de Buzzer]
Voz[Serviço de Voz]
DB[(SQLite)]
App --> Auth
App --> Idosos
...
* Testes realizados;
* Resultados obtidos;
* Espaço para link do repositório GitHub.

📸 Registros do Projeto

Adicione nesta seção imagens do projeto, como prints da interface, montagem do Raspberry Pi, câmera, GPS, MPU6050, buzzer e mensagens recebidas no Telegram.
