...
def processar_obstaculo_camera(obstaculos):
    ...
    with app.app_context():
        ...
        try:
            ...
            try:
                ...
                foto_nome, foto_caminho = capturar_foto_queda()

            except Exception as erro:

                print(
                    "[CÂMERA] Erro ao capturar foto da queda:",
                    erro
                )
...
if __name__ == "__main__":
    ...
    thread_camera = threading.Thread(
        target=monitorar_obstaculos,
        args=(
            processar_obstaculo_camera,
        ),
        daemon=True,
        name="monitor-camera-obstaculos"
    )
